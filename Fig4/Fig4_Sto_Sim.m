...
for cell=1:1000
    [t,y] = ExactStochWendy(@(t,y) SDE(t,y,IC_left,IC_right),[t0 t0+200],IC);
    gfp=[gfp y(:,1).'];
    GFP=[GFP y(:,2).'];
    rfp=[rfp y(:,3).'];
    RFP=[RFP y(:,4).'];
    ...
    t0=t(end);
    IC=y(end,:);
    save(['Stoch_R1_' num2str(Rs) '_RC_woFluc.mat'])
end
...
function [S, P, K] = SDE(~,y,IC_left,IC_right)
global km01 km1 kp1 dm1 dp1 cp1 Jm1 Jp1
global km02 km2 kp2 dm2 dp2 cp2 Jm2 Jp2
global n Kg Omega  
...
PFp1=1+m1/Omega/Jp1+IC1(3)/Omega/Jp2;
PFp2=1+IC2(1)/Omega/Jp1+m2/Omega/Jp2;
