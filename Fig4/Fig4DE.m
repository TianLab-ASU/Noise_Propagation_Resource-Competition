...
g1=km01*Omega+km1*R1/PFm1*Omega;
f1=m1*dm1;

g2=kp1*m1/PFp1;
f2=p1*dp1;

g3=km02*Omega+km2*R2/PFm2*Omega;
f3=m2*dm2;
...
legend('\eta_{p_2 total}','\eta_{{p_2}<-{m_2}<-{p_1}<-{m_1}}','\eta_{{p_2}<-{m_2}<-{p_1}}','\eta_{{p_2}<-{m_2}}','\eta_{{p_2}<-{p_2}}','location','northwest')
box on
axis square
set(gca,'xscale','log')
xlim([0.01 2])
